...
@Autonomous
public class ReedAutoRight extends LinearOpMode {
    public class Arm{
        private Servo elbow;
        private Servo wrist;
    ...
    public class Claw{
        ...
        public Claw(HardwareMap hardwareMap){
            leftWheel = hardwareMap.get(Servo.class, "ISL");
            rightWheel = hardwareMap.get(Servo.class, "ISR");
        }
    ...
    public void runOpMode() {
        ...
        Action place0 = drive.actionBuilder(new Pose2d(24, -61, Math.toRadians(0)))
                .setTangent(Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(48, -48), Math.toRadians(0))
                .build();
        Action align1 = drive.actionBuilder(new Pose2d(48, -48, Math.toRadians(0)))
                .setTangent(Math.toRadians(90))
        ...
        Action place1 = drive.actionBuilder(new Pose2d(48, -40, Math.toRadians(90)))
                ...
                .build();
        Action align2 = drive.actionBuilder(new Pose2d(48, -48, Math.toRadians(270)))
                .setTangent(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(40, -24, Math.toRadians(0)), Math.toRadians(0))
                .build();
        Action grab2 = drive.actionBuilder(new Pose2d(40, -24, Math.toRadians(0)))
                .setTangent(Math.toRadians(0))
                .lineToX(46)
                .build();
        Action place2 = drive.actionBuilder(new Pose2d(46, -24, Math.toRadians(0)))
                .setTangent(Math.toRadians(270))
                .strafeToLinearHeading(new Vector2d(48, -48), Math.toRadians(270))
                .build();
        Action align3 = drive.actionBuilder(new Pose2d(48, -48, Math.toRadians(270)))
                .setTangent(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(48, -24, Math.toRadians(0)), Math.toRadians(0))
                .build();
        Action grab3 = drive.actionBuilder(new Pose2d(48, -24, Math.toRadians(0)))
                .setTangent(Math.toRadians(0))
                .lineToX(56)
                .build();
        Action place3 = drive.actionBuilder(new Pose2d(56, -24, Math.toRadians(0)))
                .setTangent(Math.toRadians(180))
                .splineToLinearHeading(new Pose2d(56, -48, Math.toRadians(270)), Math.toRadians(270))
                .build();
        Action park = drive.actionBuilder(new Pose2d(56, -48, Math.toRadians(270)))
                .setTangent(Math.toRadians(270))
                .lineToY(-56)
                .build();
